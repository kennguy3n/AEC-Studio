...
describe("ValidatorPanel", () => {
  ...
  // Regression test: the `revalidate` callback's `try/finally` /
  // `catch` covers bridge failures from real OS paths supplied by
  // the file picker. File-moved / permission-denied /
  // malformed-IFC errors would otherwise become silent unhandled
